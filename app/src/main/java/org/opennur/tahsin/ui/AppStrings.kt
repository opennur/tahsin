...
class Strings(
    ...
    // Peta Khatam
    val petaTitle: String,
    val petaSubtitle: String,
    val petaViewPages: String,
    val petaViewJuz: String,
    val petaLegendGood: String,
    val petaLegendReview: String,
    val petaLegendUntouched: String,
    val petaSummary: String,
    val petaNoData: String,
...
object AppStrings {
    ...
    val Indonesian = Strings(
        ...
        // Peta Khatam
        petaTitle = "🗺️ Peta Khatam",
        petaSubtitle = "Pantau progres khatam Al-Qur\u2019anmu. Setiap kotak = satu halaman mushaf.",
        petaViewPages = "Halaman",
        petaViewJuz = "Juz",
        petaLegendGood = "Sudah dikhatamkan",
        petaLegendReview = "Perlu muraja\u2019ah",
        petaLegendUntouched = "Belum dibaca",
        petaSummary = "%d%% halaman dikhatamkan",
        petaNoData = "Belum ada data bacaan. Mulai latihan di Tahsin untuk mengisi peta.",
        tahsinPage = "Halaman",
        tahsinJuz = "Juz",
    ...
    val English = Strings(
        ...
        // Peta Khatam
        petaTitle = "🗺️ Khatam Map",
        petaSubtitle = "Track your Qur'an completion progress. Each square = one mushaf page.",
        petaViewPages = "Pages",
        petaViewJuz = "Juz",
        petaLegendGood = "Completed",
        petaLegendReview = "Needs review",
        petaLegendUntouched = "Not yet read",
        petaSummary = "%d%% pages completed",
        petaNoData = "No reading data yet. Start practicing in Tahsin to fill the map.",
        tahsinPage = "Page",
        tahsinJuz = "Juz",
